...
| V7   | `POST /v7/ocr/jobs`    | Rabbit/Kafka + Backpressure | Python Worker 1/2/4 | 큐 길이 기반 Backpressure로 시스템 보호 |

### 3.2 공통 도메인

모든 비동기 버전(V3~V7)에서 아래 도메인을 공유합니다.
